...
var _objectsJson = require("../../data/objects.json");
var _objectsJsonDefault = parcelHelpers.interopDefault(_objectsJson);
var _cardsHbs = require("../view/comp/cards.hbs");
...
(0, _jqueryDefault.default)(document).ready(()=>{
    (0, _utils.initTooltips)();
    (0, _jqueryDefault.default)(document).on("click", ".card", function(e) {
        const modal = (0, _jqueryDefault.default)(document).find("#modal");
        (0, _utils.fillModal)(modal, (0, _jqueryDefault.default)(this));
    });
    (0, _jqueryDefault.default)(document).on("keydown", (0, _utils.navigateCards));
    (0, _jqueryDefault.default)(document).on("click", "#modal .slide-btn", function() {
        const modal = (0, _jqueryDefault.default)(document).find("#modal");
        const cardsList = (0, _jqueryDefault.default)(document).find(".card").toArray().map((item)=>{
            return (0, _jqueryDefault.default)(item).attr("id");
        });
        const current = cardsList.findIndex((element)=>element == modal.attr("current-item"));
        if (current == -1) throw new Error("invalid card index");
        if ((0, _jqueryDefault.default)(this).hasClass("btn-prev")) {
            const prevSlide = current > 0 ? cardsList[current - 1] : cardsList[cardsList.length - 1];
            (0, _utils.fillModal)(modal, (0, _jqueryDefault.default)(document).find(`#${prevSlide}`));
        } else if ((0, _jqueryDefault.default)(this).hasClass("btn-next")) {
            const nextSlide = current < cardsList.length - 1 ? cardsList[current + 1] : cardsList[0];
            (0, _utils.fillModal)(modal, (0, _jqueryDefault.default)(document).find(`#${nextSlide}`));
        }
    });
    const loadButton = (0, _jqueryDefault.default)("#toastbtn");
    console.log(loadButton);
    console.log("Длина");
    console.log((0, _jqueryDefault.default)(document).find("#new-card-modal").length);
    const newCardModal = new _bootstrap.Modal((0, _jqueryDefault.default)("#new-card-modal"));
    console.log((0, _jqueryDefault.default)("#new-card-modal"));
    console.log("Hello");
    const newCardForm = (0, _jqueryDefault.default)("#new-card-form")[0];
    const saveNewButton = (0, _jqueryDefault.default)("#save-new-button")[0];
    const saveButton = (0, _jqueryDefault.default)("#save-button")[0];
    (0, _jqueryDefault.default)("#toastbtn").on("click", ()=>{
        (0, _jqueryDefault.default)("#new-img, #new-name, #new-description").val("");
        newCardModal.show();
    });
    const objects = [];
    objects.push(...(0, _objectsJsonDefault.default));
    function renderCards() {
        const html = (0, _cardsHbsDefault.default)({
            objects
        });
        cards.innerHTML = html;
    }
    saveNewButton.addEventListener("click", (event)=>{
        const newModal = (0, _jqueryDefault.default)("#new-card-modal");
        const newimg = (0, _jqueryDefault.default)("#new-img").val();
        const newName = (0, _jqueryDefault.default)("#new-name").val();
        const newDescription = (0, _jqueryDefault.default)("#new-description").val();
        // if (!newimg || !newName) {
        ...
        let html = (0, _cardsHbsDefault.default)({
            objects
        });
        let app = document.getElementById("cards");
        app.innerHTML = html;
        event.preventDefault();
        const bootstrapModal = _bootstrap.Modal.getInstance(newModal);
        bootstrapModal.hide();
    });
    saveButton.addEventListener("click", (event)=>{
        const newModal = (0, _jqueryDefault.default)("#card-modal");
        const newimg = (0, _jqueryDefault.default)("#img").val();
        const newName = (0, _jqueryDefault.default)("#name").val();
        const newDescription = (0, _jqueryDefault.default)("#description").val();
        // if (!newimg || !newName) {
        //   alert("Заполните все поля формы!");
        //   return;
        // }
        ...
        //   return;
        // }
        const id = (0, _jqueryDefault.default)("#modal").attr("current-item");
        const elements = id.split("-").slice(1) - 1;
        objects[elements].img = (0, _jqueryDefault.default)("#img").val();
        objects[elements].name = (0, _jqueryDefault.default)("#name").val();
        objects[elements].description = (0, _jqueryDefault.default)("#description").val();
        let html = (0, _cardsHbsDefault.default)({
            objects
        });
        let app = document.getElementById("cards");
...
},{"jquery":"hgMhh","bootstrap":"h36JB","./utils":"gj9AD","../../data/objects.json":"30NTX","../view/comp/cards.hbs":"bDDA8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gj9AD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initTooltips", ()=>initTooltips);
parcelHelpers.export(exports, "fillModal", ()=>fillModal);
parcelHelpers.export(exports, "navigateCards", ()=>navigateCards);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
var _bootstrap = require("bootstrap");
const initTooltips = ()=>{
    ...
    var tooltipList = tooltipTriggerList.map(function(tooltipTriggerEl) {
        return new _bootstrap.Tooltip(tooltipTriggerEl);
    });
};
const fillModal = (modal, source)=>{
    (0, _jqueryDefault.default)("#img").val(source.find(".card-img-top").html());
    (0, _jqueryDefault.default)("#name").val(source.find(".card-title").html());
    (0, _jqueryDefault.default)("#description").val(source.find(".card-text").html());
...
const navigateCards = (e)=>{
    ...
    if (e.which == 37) {
        const prevSlide = current > 0 ? cardsList[current - 1] : cardsList[cardsList.length - 1];
        fillModal(modal, (0, _jqueryDefault.default)(document).find(`#${prevSlide}`));
    } else if (e.which == 39) {
        const nextSlide = current < cardsList.length - 1 ? cardsList[current + 1] : cardsList[0];
        fillModal(modal, (0, _jqueryDefault.default)(document).find(`#${nextSlide}`));
    }
};

},{"jquery":"hgMhh","bootstrap":"h36JB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"30NTX":[function(require,module,exports) {
module.exports = JSON.parse('[{"id":1,"img":"https://vsegda-pomnim.com/uploads/posts/2022-04/1651038789_17-vsegda-pomnim-com-p-zakat-bez-morya-foto-23.jpg","name":"Литва","description":"Описание"},{"id":2,"img":"https://fikiwiki.com/uploads/posts/2022-02/1645018914_4-fikiwiki-com-p-zakati-krasivie-kartinki-4.jpg","name":"Россия","description":"Описание"},{"id":3,"img":"https://fikiwiki.com/uploads/posts/2022-02/1645018871_8-fikiwiki-com-p-zakati-krasivie-kartinki-9.jpg","name":"Мальдивы","description":"Описание"},{"id":4,"img":"https://proprikol.ru/wp-content/uploads/2020/02/krasivye-kartinki-pro-zakaty-na-rabochij-stol-5.jpg","name":"Польша","description":"Описание"},{"id":5,"img":"https://klike.net/uploads/posts/2022-08/1661942284_j-28.jpg","name":"Япония","description":"Описание"}]');

},{}]},["2lJQV","fgDBQ"], "fgDBQ", "parcelRequire74f0")
